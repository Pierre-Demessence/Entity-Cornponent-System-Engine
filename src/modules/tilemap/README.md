...
- **Batched/baked tilemap rendering** — planned. This module spawns standard
  sprite entities; until then the consumer decides how to render (the tilemap
  example bakes the layer to one offscreen canvas).
