...
import { BulletDef, BulletTag, Position3DDef, RadiusDef, TargetTag } from '../components';
import { BOUNDS_RADIUS } from '../game';

/**
 * Expires each bullet on TTL or when it leaves the play boundary, and destroys
